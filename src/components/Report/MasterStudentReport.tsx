...
export default function MasterStudentReport() {
    ...
    return (
        ...
        data-tooltip-id="student-export-rreport-tooltip"
        data-tooltip-content="Export Students Reports" 
        >
        ...
        <svg className="w-5 h-5 inline-block"
                                ...
                                >
                                    ...
                                    <ReactTooltip id="student-export-rreport-tooltip" place="top" effect="solid" />
